...
Main {
    public static void main(String[] args) {
        ...
        //Adding the newly created and manipulated object to the cupcake menu ArrayList
        ...
        Soda soda = new Soda();
        Milk milk = new Milk();
        System.out.println("\nWe are in the middle of creating the drink menu. We currently have three types of drinks on the menu but we need to decide on pricing");
        ...
        soda.type();
        System.out.println("How much would you like to charge for the bottled soda? (Input a numerical number taken to 2 decimal places)");
        priceText = input.nextLine();
        price = Double.parseDouble(priceText);
        soda.setPrice(price);
        System.out.println("We are deciding on the price for our bottle of milk. Here is the description: ");
        milk.type();
        System.out.println("How much would you like to charge for the bottled milk? (Input a numerical number taken to 2 decimal places)");
        priceText = input.nextLine();
        price = Double.parseDouble(priceText);
        milk.setPrice(price);
        drinkMenu.add(water);
